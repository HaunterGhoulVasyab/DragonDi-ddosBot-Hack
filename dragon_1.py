...
TARGET_CPS = int(5000)
ATTACK_TIME = int(25)
protocols_list = ['761', '760', '759', '758', '757', '756', '755', '754', '753', '751', '736', '735', '578', '575', '573', '498', '490', '485', '480', '477', '404', '401', '393', '340', '338', '335', '316', '315', '210', '110', '109', '108', '107', '47', '5', '4', '78', '74', '73', '61', '60']
...
async def free_attack(ctx, host, proto, method,):
    if proto not in protocols_list:
        if ctx.channel.id == 1060479195349790820:
            embed=discord.Embed(title="**Error-protocol**", description="**неверный protocol**")
            embed.set_author(name="**Error**", icon_url="https://media.discordapp.net/attachments/830451658672177152/1063104178001547427/willatookis_dragon_abstract_5d42358a-7633-4e1f-96e6-f49e58ab329c__1_-round.YgZfF.png?width=670&height=670")
            embed.set_thumbnail(url="https://media.discordapp.net/attachments/830451658672177152/1063104178001547427/willatookis_dragon_abstract_5d42358a-7633-4e1f-96e6-f49e58ab329c__1_-round.YgZfF.png?width=670&height=670")
            embed.add_field(name="протоколы", value="```.protocol```", inline=False)
